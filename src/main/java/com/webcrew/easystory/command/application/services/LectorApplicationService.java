package com.webcrew.easystory.command.application.services;

import com.webcrew.easystory.command.application.commands.RegisterLector;
import com.webcrew.easystory.command.application.dtos.LectorView;
import com.webcrew.easystory.command.application.dtos.RegisterLectorRequest;
import com.webcrew.easystory.command.application.dtos.RegisterLectorResponse;
import com.webcrew.easystory.command.application.enums.ResultType;
...
import com.webcrew.easystory.query.GetClientByIdQuery;
import com.webcrew.easystory.command.application.validators.EditLectorValidator;
import com.webcrew.easystory.command.application.validators.RegisterLectorValidator;
